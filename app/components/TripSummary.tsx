                ...
                <div className="max-w-6xl mx-auto px-4 md:px-6">
                    ...
                    <div className="mt-8 max-w-5xl mx-auto">
                        <div className="bg-white border border-gray-300 border-t-0 shadow-[0_-2px_0_0_black] overflow-hidden">
                            ...
                            {/* 중요 안내사항 */}
                            <div className="border-t border-gray-300 flex flex-col md:flex-row">
                                <div className="bg-white font-semibold text-gray-700 px-6 py-5 md:w-52 text-base md:text-lg whitespace-nowrap text-left flex items-start justify-start gap-2 flex-shrink-0">
                                    <svg className="w-5 h-5 text-amber-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z" />
                                    </svg>
                                ...
                                <ul className="px-5 py-5 space-y-2 flex-1">
                                    <li className="flex items-start gap-2 text-sm md:text-base text-gray-600 leading-relaxed">
                                        <span className="text-gray-400 flex-shrink-0">▣</span>
